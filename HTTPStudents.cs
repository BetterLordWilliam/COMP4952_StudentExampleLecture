...
public class HTTPStudents
{
    private readonly ILogger<HTTPStudents> _logger;
    private readonly SchoolContext _context;

    public HTTPStudents(ILogger<HTTPStudents> logger, SchoolContext context)
    {
        _logger = logger;
        _context = context;
    }
    ...
    {
        _logger.LogInformation("C# HTTP GET trigger processed for get students");
